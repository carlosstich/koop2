...
module.exports = { isTable: isTable, getExtent: getExtent, getGeomType: getGeomType, detectType: detectType, esriTypeMap: esriTypeMap }
...
function isTable (data) {
  ...
  var geometryType = (data.metadata && data.metadata.geometryType) || getGeomType(data)
  if (geometryType) { return false }

  // Check for a valid fullExtent. If unset, assume this is a Table
  var fullExtent = data.fullExtent || (data.metadata && data.metadata.fullExtent)
