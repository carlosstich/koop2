...
function composeRouteString (routePath, namespace, options) {
  ...
  var disableIdParam = options.disableIdParam;
  var absolutePath = options.absolutePath;
  var routePrefix = options.routePrefix; if ( routePrefix === void 0 ) routePrefix = '';
  var paramFragment = ''
  var paramsPlaceholder = '$providerParams'
  var namespacePlaceholder = '$namespace'
...
module.exports = { composeRouteString: composeRouteString }
